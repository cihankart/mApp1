...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonItem, IonLabel, IonDatetime, IonFooter, IonBackButton, IonButtons, IonButton, IonIcon } from '@ionic/react';
import './Date1.css';
    ...
    <IonPage>
       <IonHeader>
        <IonToolbar>
            ...
            <IonBackButton>Geri Dön</IonBackButton>
            </IonButtons>

          <IonTitle>Mesai Tarihleri Seç:</IonTitle>
        </IonToolbar>
</IonHeader> 
      <IonContent>
        <IonItem>
      ...
      <IonFooter>
        <IonToolbar>
          ...
          <IonButton slot="end" color="primary" shape="round" fill="solid"  routerLink="/Date1" >
